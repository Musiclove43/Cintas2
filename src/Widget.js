...
const rows = [
  createData('Rude Yellow', 159, 6.0, 24, 4.0),
  createData('Lobby Dispenser', 237, 9.0, 37, 4.3),
  createData('Basement Dispenser', 262, 16.0, 24, 6.0),
  createData('Garage Dispensor', 305, 3.7, 67, 4.3),
  createData('Lab Dispensor', 356, 16.0, 49, 3.9),
];
